        ...
        >
            <ScrollView contentContainerStyle={globalStyles.FomsContainer}>
                    ...
                    {({ handleChange, handleBlur, handleSubmit, values, setFieldValue, setFieldTouched, errors, touched }) => (
                        <View>
                            <DropDownMultiQuestion
                                ...
                                subcategories={subcategories18f}  // Lista de subcategorías
                                selectedCategory={values.P18f.response[0].idoptresponse}
                                selectedSubcategories={values.P18f.response[0].responseuser || []}
                                onCategoryChange={(value) => setFieldValue('P18f.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18f.response[0].responseuser', value)}
                                ...
                                selectedSubQuestions={values.P18f.response[0].subQuestion1Responses || {}} // Inicializa con respuestas vacías
                            ...
                            <DropDownMultiQuestion
                                ...
                                subcategories={subcategories18g}  // Lista de subcategorías
                                selectedCategory={values.P18g.response[0].idoptresponse}
                                selectedSubcategories={values.P18g.response[0].responseuser || []}
                                onCategoryChange={(value) => setFieldValue('P18g.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18g.response[0].responseuser', value)}
                                onSubQuestionChange={(index, subcategoryValue, value) => {
                                ...
                                selectedSubQuestions={values.P18g.response[0].subQuestion1Responses || {}} // Inicializa con respuestas vacías
                            ...
                            <DropDownMultiQuestion
                                ...
                                subcategories={subcategories18h}  // Lista de subcategorías
                                selectedCategory={values.P18h.response[0].idoptresponse}
                                selectedSubcategories={values.P18h.response[0].responseuser || []}
                                onCategoryChange={(value) => setFieldValue('P18h.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18h.response[0].responseuser', value)}
                                onSubQuestionChange={(index, subcategoryValue, value) => {
                                ...
                                selectedSubQuestions={values.P18h.response[0].subQuestion1Responses || {}} // Inicializa con respuestas vacías
                            ...
                            <DropDownMultiQuestion
                                ...
                                subcategories={subcategories18i}  // Lista de subcategorías
                                selectedCategory={values.P18i.response[0].idoptresponse}
                                selectedSubcategories={values.P18i.response[0].responseuser || []}
                                onCategoryChange={(value) => setFieldValue('P18i.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18i.response[0].responseuser', value)}
                                onSubQuestionChange={(index, subcategoryValue, value) => {
                                ...
                                selectedSubQuestions={values.P18i.response[0].subQuestion1Responses || {}} // Inicializa con respuestas vacías
                            ...
                            <DropDownMultiQuestion
                                ...
                                subcategories={subcategories18j}  // Lista de subcategorías
                                selectedCategory={values.P18j.response[0].idoptresponse}
                                selectedSubcategories={values.P18j.response[0].responseuser || []}
                                onCategoryChange={(value) => setFieldValue('P18j.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18j.response[0].responseuser', value)}
                                onSubQuestionChange={(index, subcategoryValue, value) => {
                                ...
                                selectedSubQuestions={values.P18j.response[0].subQuestion1Responses || {}} // Inicializa con respuestas vacías
                ...
                <View style={globalStyles.buttonsBanner}>
                    ...
                    <NextComponent onNextPress={() => navigation.navigate('page8' as never)} />
                </View>
            </ScrollView>
        </KeyboardAvoidingView>
    );
