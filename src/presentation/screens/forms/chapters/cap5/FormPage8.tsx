                    ...
                    {({ handleChange, handleBlur, handleSubmit, values, setFieldValue, setFieldTouched, errors, touched }) => (
                        <View>
                            <DropDownMultiQuestion
                                ...
                                onCategoryChange={(value) => setFieldValue('P18k.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18k.response[0].responseuser', value)}
                            ...
                            <DropDownMultiQuestion
                                ...
                                onCategoryChange={(value) => setFieldValue('P18l.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18l.response[0].responseuser', value)}
                                onSubQuestionChange={(index, subcategoryValue, value) => {
                            ...
                            <DropDownMultiQuestion
                                ...
                                onCategoryChange={(value) => setFieldValue('P18m.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18m.response[0].responseuser', value)}
                                onSubQuestionChange={(index, subcategoryValue, value) => {
                            ...
                            <DropDownMultiQuestion
                                ...
                                onCategoryChange={(value) => setFieldValue('P18n.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18n.response[0].responseuser', value)}
                                onSubQuestionChange={(index, subcategoryValue, value) => {
                            ...
                            <DropDownMultiQuestion
                                ...
                                onCategoryChange={(value) => setFieldValue('P18o.response[0].idoptresponse', value)}
                                onSubcategoryChange={(value) => setFieldValue('P18o.response[0].responseuser', value)}
                                onSubQuestionChange={(index, subcategoryValue, value) => {
