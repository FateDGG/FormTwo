...
import { Alert, Button, KeyboardAvoidingView, Platform, Text, View, TextInput } from 'react-native';
            ...
            <View >
              <InputComponent
                ...
                handleChange={(value: string) => {
                  ...
                  setFieldValue('P1.response[0].responseuser[0]', onlyLetters);
                }}
              ...
              <NumericInputComponent
                ...
                handleChange={(value: string) => {
                  ...
                  setFieldValue('P3.response[0].responseuser[0]', onlyNumbers);
                }}
